...
<head>
    ...
    <script defer src="https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/contrib/auto-render.min.js" onload="
        const renderOptions = {
            delimiters: [
        ...
        new MutationObserver((mutations) => {
            mutations.forEach((mutation) => {
                mutation.addedNodes.forEach((node) => {
                    if (node.nodeType === 1) renderMathInElement(node, renderOptions);
                });
            });
...
<body class="bg-gray-100 font-sans antialiased">
    <div class="absolute top-4 right-4 z-10 flex items-center space-x-4">
        ...
        <div class="flex items-center space-x-4 text-sm font-medium text-gray-700">
            <a href="{{ route('documentation') }}" class="hover:text-gray-900">Inicio</a>

            <a href="{{ route('test3') }}" class="hover:text-gray-900">Test</a>
        </div>
